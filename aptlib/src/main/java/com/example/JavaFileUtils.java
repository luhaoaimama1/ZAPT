...
public class JavaFileUtils {
    ...
    public static void write (ElementResolver mElementCheckHelper, ClassEntity classEntity, String content) throws IOException {

        String generateValue = classEntity.getAPTClassName();
        if (classEntity.getElement()!=null&&!generateCache.contains(generateValue)) {
